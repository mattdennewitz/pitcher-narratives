...
last_updated: "2026-04-03T03:18:54Z"
...
- load_all_statcast returns empty DataFrame (not error) on no files, matching skip-missing-year pattern
- load_full_agg delegates to load_csv(filename, None) for consistent filtering and date parsing
